...
export default function Login({navigation}) {
  ...
  return (
    <View style={{width: '100%', height: '100%', position: 'relative'}}>
      {loading && <Spinner style={styles.spinners} color="blue" />}
      <Content
        ...
        <Card>
          ...
          <CardItem>
            <Content>
              ...
              <Button onPress={onLogin} block info style={{marginTop: 20}}>
                <Text>Login</Text>
              </Button>
              <View
                style={{
                ...
                onPress={{onRegister}}>
                <Text style={{marginTop: 3}}>Not a member? </Text>
                <Button transparent style={{height: 30, marginRight: 10}}>
                  <Text onPress={onRegister} style={{fontSize: 12}}>
                    Signup now{' '}
                  </Text>
                </Button>
              </View>
